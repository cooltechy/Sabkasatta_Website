...
<?php 
	...
	if(isset($_POST['btn_submit'])){
		...
		$update = $_POST['insert'];
		$qry = "INSERT INTO value(name_id,value) VALUES(3,'$update')";
...
<body>
	...
	<div class="row">
		...
		<div class="col-md-4 col-10 d-block m-auto">
			<br>
			<h2 class="text-primary text-center">Ghaziabad Update Window</h2>
			<br>
			<form class="form-group" action="ghaziabad.php" method="POST" autocomplete="off">
