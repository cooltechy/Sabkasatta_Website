...
<?php 
	...
	if(isset($_POST['btn_submit'])){
		...
		$update = $_POST['insert'];
		$qry = "INSERT INTO value(name_id,value) VALUES (2,'$update')";
...
<body>
	<div class="row">
		...
		<div class="col-md-4 col-10 d-block m-auto">
			<br><br><br><br>
			<h2 class="text-primary text-center">Faridabad Update Window</h2>
			<br>
			<form class="form-group" action="faridabad.php" method="POST" autocomplete="off">
