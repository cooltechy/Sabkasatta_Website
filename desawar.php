...
<?php 
	...
	if(isset($_POST['btn_submit'])){
		...
		$date = $_POST['date'];
		$update = $_POST['insert'];
		$qry = "INSERT into value(name_id,date,value) VALUES(1,'$date','$update')";
...
<body>
	...
	<div class="row">
		...
		<div class="col-md-4 col-10 d-block m-auto">
			<br><br><br><br>
			<h2 class="text-primary text-center">Desawar Update Window</h2>
			<br>
			<form class="form-group" action="desawar.php" method="POST" autocomplete="off">
				<label for="date">Date:</label>
				<input type="number" name="date" placeholder="Enter Date" class="form-control" required="">
				<br>
				...
				<br>
				<button class="btn btn-primary rounded-0 block" name="btn_submit">SUBMIT</button>
			</form>
